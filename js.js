...
save.addEventListener('touchstart', () => {
...
for (let i = 0; i < colorList.length; i++) {
    colorList[i].addEventListener("touchstart", () => {
...
for (let i = 0; i < weightList.length; i++) {
    weightList[i].addEventListener("touchstart", () => {
...
eraser16.addEventListener('touchstart', () => {
    document.body.style.cursor = `url('img/eraser16.ico') 8 8, auto`
    eraserSize = 8
})

eraser32.addEventListener('touchstart', () => {
    document.body.style.cursor = `url('img/eraser32.ico') 16 16, auto`
    eraserSize = 16
})

eraser48.addEventListener('touchstart', () => {
    document.body.style.cursor = `url('img/eraser48.ico') 24 24, auto`
    eraserSize = 24
})

eraser64.addEventListener('touchstart', () => {
